...
from states.malumot2 import malumot2
...
async def enter_test(message: types.Message):
    ...
    await malumot2.fullname.set()

@dp.message_handler(state=malumot2.fullname)
...
@dp.message_handler(state=malumot2.phoneNumber)
